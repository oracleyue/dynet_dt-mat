function [input, output, boolnet] = dynet_sim(model, varargin)
...
argParser.FunctionName = 'dynet_sim';
...
switch method
  ...
  case 'euler-maruyama'
    ...
    sys.A = A; sys.B = B; sys.C = C; sys.D = D; sys.K = K;
