function fig_hl = topolo_err(boolNets, groundTruth, morders)
% ROC is to plot the curve of two types topology errors in terms
%    of the given variable (e.g. model orders, labmdas).
%   Type I  Error = 1 - TP/(TP+FP)
...
plot(morders, TypeIError, '--o');
hold on;
plot(morders, TypeIIError, '--s');
hold off;
ylim([0 1]);
